...
public class DateReportFragment extends Fragment {
    ...
    public static DateReportFragment newInstance() {
        DateReportFragment fragment = new DateReportFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btnExecute = rootView.findViewById(R.id.btnClean);
        btnClean = rootView.findViewById(R.id.btnExecute);
                                ...
                                try {
                                    Collections.sort(itemList, new Comparator<Item>() {
                                        ...
                                        public int compare(Item lhs, Item rhs) {
                                            try {
                                                if (format.parse(lhs.getDate()).after(format.parse(rhs.getDate())))
                                                    return 1;
                                                else if (format.parse(lhs.getDate()).before(format.parse(rhs.getDate())))
                                                    return -1;
                                            } catch (ParseException e) {
                                                e.printStackTrace();
                                            }
